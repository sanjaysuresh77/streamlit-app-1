...
# ===== Function to Set Background with CSS and Hide Header Box =====
def set_background():
    ...
    st.markdown(f"""
        <style>
        /* Remove Streamlit's default header and first top block */
        ...
        .glass {{
            ...
            max-width: 850px;
            margin: auto;
            margin-top: 4rem; /* Increased top margin so it doesn't cover "EDRC" */
        }}
